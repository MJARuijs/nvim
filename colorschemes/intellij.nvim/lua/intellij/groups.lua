...
local function reloadTheme()
    ...
    result = {
        ...
        ["@variable.member.java"] = { fg = colors.variable },
        ...
        ["@keyword.import.java"] = { fg = colors.keyword },
        ["@keyword.repeat.java"] = { fg = colors.keyword },
        ["@keyword.exception.java"] = { fg = colors.keyword },
        ["@keyword.operator.java"] = { fg = colors.keyword },
        ["@operator.java"] = { fg = colors.text },
        ...
        ["@lsp.typemod.namespace.importDeclaration.java"] = { fg = colors.text },
        ...
        lightCursor = { bg = "#ffffff" },
        darkCursor = { bg = "#999999" },
        -- CursorIM = { bg = "#ff0000" },
